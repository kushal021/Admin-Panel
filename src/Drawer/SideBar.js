        ...
        <div>
            ...
            <List>
                {SideBarData.map((text, index) => {
                    if (text.parentTitle === "") {
                        return (
                            <Link key={index} style={{ textDecoration: 'none', color: 'black' }} to={text.child.path}>
                                <ListItem button>
                                    <ListItemText primary={text.child.childTitle} />
                                </ListItem>
                            </Link>
                        );
                                ...
                                <Collapse in={imageOpen} timeout="auto" unmountOnExit>
                                    <List component="div" disablePadding>
                                        {text.child.map((item, indexChild) => (
                                            <Link key={indexChild} style={{ textDecoration: 'none', color: 'black' }} to={item.path}>
